export const HTMLResetPsw = ({ resetLink, domain }: { resetLink: string; domain: string | undefined }) => `<table
        id="m_-1603865318309049035m_2725105697623234912u_body"
          ...
          <tr style="vertical-align:top">
            <td style="word-break:break-word;border-collapse:collapse!important;vertical-align:top">
              <div style="padding:0px;background-color:transparent">
                <div style="margin:0 auto;min-width:320px;max-width:600px;word-wrap:break-word;word-break:break-word;background-color:#003399">
                  <div style="border-collapse:collapse;display:table;width:100%;height:100%;background-color:transparent">
                    <div style="max-width:320px;min-width:600px;display:table-cell;vertical-align:top">
                      <div style="height:100%;width:100%!important;background-color: rgba(244,145,4,1);">
                        <div style="box-sizing:border-box;height:100%;padding:0px;border-top:0px solid transparent;border-left:0px solid transparent;border-right:0px solid transparent;border-bottom:0px solid transparent">
                          <table
                            id="m_-1603865318309049035m_2725105697623234912u_content_image_2"
                                      ...
                                      <tr>
                                        <td style="padding-right:0px;padding-left:0px" align="center">
                                          <img
                                            align="center"
                                            border="0"
                                            src="https://raw.githubusercontent.com/ioeridev/assets/public/mail/reset-pswd-header.png"
                                            alt="Image"
                                            title="Image"
                                            style="outline:none;text-decoration:none;clear:both;display:inline-block!important;border:none;height:auto;float:none;width: 36%;max-width: 220px;"
                                            width="150.8"
                                            class="CToWUd"
                                            data-bit="iit"
                                          >
                              ...
                              <tr>
                                ...
                                >
                                  <div style="font-size:14px;color:#e5eaf5;line-height:140%;text-align:center;word-wrap:break-word">
                                    <span style="font-size: 14px;line-height:39.2px">
                                      <strong>
                                        <span style="line-height:39.2px;font-size: 16px;color: #000;">
                                  ...
                                  <div style="font-size:14px;color:#e5eaf5;line-height:140%;text-align:center;word-wrap:break-word">
                                    <span style="font-size:28px;line-height:39.2px">
                                      <strong>
                                        <span style="line-height:39.2px;font-size:28px;color: #000;">Keep your account secure</span>
                                      </strong>
                                    </span>
                                  </div>
                                </td>
                        ...
                        <div style="box-sizing:border-box;height:100%;padding:0px;border-top:0px solid transparent;border-left:0px solid transparent;border-right:0px solid transparent;border-bottom:0px solid transparent">
                          ...
                          >
                            <tbody>
                              <tr>
                                <td
                                  style="word-break:break-word;padding: 80px 18px 60px 18px;font-family:'Cabin',sans-serif"
                                  align="left"
                                >
                                  <div align="center">
                                    <a
                                      href="${resetLink}"
                                      style="box-sizing:border-box;display:inline-block;text-decoration:none;text-align:center;color:#ffffff;background-color:#ff9800;border-radius:4px;width:auto;max-width:100%;word-break:break-word;word-wrap:break-word;border-top-color:#f49104;border-top-style:solid;border-top-width:3px;border-left-color:#f49104;border-left-style:solid;border-left-width:3px;border-right-color:#f49104;border-right-style:solid;border-right-width:3px;border-bottom-color:#f49104;border-bottom-style:solid;border-bottom-width:3px;font-size:14px"
                                      rel="noopener noreferrer nofollow"
                                      target="_blank"
                                    >
                                      <span style="display:block;padding:6px 36px;line-height:130%">
                                        <span style="font-size:16px;line-height:20.8px">
                                          <strong>
                                            <span style="line-height:20.8px;font-size:16px">RESET MY PASSWORD</span>
                                          </strong>
                                        </span>
                                      </span>
                                    </a>
              ...
              <div style="padding:0px;background-color:transparent">
                <div style="margin:0 auto;min-width:320px;max-width:600px;word-wrap:break-word;word-break:break-word;background-color:#e5eaf5">
                  <div style="border-collapse:collapse;display:table;width:100%;height:100%;background-color:transparent">
                    <div style="max-width:320px;min-width:600px;display:table-cell;vertical-align:top">
                                        ...
                                        <tbody>
                                          <tr style="vertical-align:top">
                                            <td
                                              ...
                                              style="word-break:break-word;border-collapse:collapse!important;vertical-align:top"
                                            >
                                              <a href="https://youtube.com/ioeri" title="YouTube" target="_blank">
                                                <img
              ...
              <div style="padding:0px;background-color:transparent">
                <div style="margin:0 auto;min-width:320px;max-width:600px;word-wrap:break-word;word-break:break-word;background-color:#f49104">
                  <div style="border-collapse:collapse;display:table;width:100%;height:100%;background-color:transparent">
                    <div style="max-width:320px;min-width:600px;display:table-cell;vertical-align:top">
                      <div style="height:100%;width:100%!important">
                        <div style="box-sizing:border-box;height:100%;padding:0px;border-top:0px solid transparent;border-left:0px solid transparent;border-right:0px solid transparent;border-bottom:0px solid transparent">
